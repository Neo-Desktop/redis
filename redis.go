...
func (redis *Redis) XFR (name string, z *Zone, record *Record) (answers, extras []dns.RR) {

    answers2, extras2 := redis.SOA(name, z, record)
    answers = append(answers, answers2...)
    extras = append(extras, extras2...)

    answers2, extras2 = redis.ANY(name, z, record)
    answers = append(answers, answers2...)
    extras = append(extras, extras2...)

    answers2, extras2 = redis.SRV(name, z, record)
    answers = append(answers, answers2...)
    extras = append(extras, extras2...)

    answers2, extras2 = redis.TXT(name, z, record)
    answers = append(answers, answers2...)
    extras = append(extras, extras2...)
...
//func (redis *Redis) IsIpXfrAllowed(state request.Request) {
//    ipRequest := net.ParseIP(state.W.RemoteAddr().String())
//
//}
